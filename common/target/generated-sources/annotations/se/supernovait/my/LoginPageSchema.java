...
import com.codename1.rad.schemas.*;
@Autogenerated
public interface LoginPageSchema {
    public static final Tag phoneEmailOrUsername = new Tag("phoneEmailOrUsername");
    public static final Tag password = new Tag("password");
    public static final Tag phoneEmailOrUsernameErrorMessage = new Tag("phoneEmailOrUsernameErrorMessage");
    public static final Tag passwordErrorMessage = new Tag("passwordErrorMessage");
    public static final ActionNode.Category LOGIN = new ActionNode.Category("LOGIN");
}
