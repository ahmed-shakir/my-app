...
public class NotificationViewController extends FormController implements INotificationViewController, FormController.CloneableFormController<NotificationViewController> {
    private Notification viewModel;
    public NotificationViewController(@Inject Controller parent) {
        super(parent);
        this.viewModel = createViewModel();
    }
    public NotificationViewController(@Inject Controller parent, @Inject Notification viewModel) {
        super(parent);
    ...
    @Override
    public NotificationViewController cloneAndReplace() {
        NotificationViewController out = new NotificationViewController(getParent(), viewModel);
        out.show();
        return out;
    }
    @Override
    protected void onStartController() {
        ...
        setView(new NotificationView(new ViewContext<Notification>(this, viewModel)));
    }
    @Override
